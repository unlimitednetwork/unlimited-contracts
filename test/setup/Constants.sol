...
uint256 constant CAROL_PK = 0x7c852118294e51e653712a81e05800f419141751be58f605c371e15141b007a6;
address constant DAN = 0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65;
uint256 constant DAN_PK = 0x47e179ec197488593b187f80a00eb0da91f1b9d0b13f8733639f19c30a34926a;
...
address constant BACKEND = 0xa0Ee7A142d267C1f36714E4a8F75612F20a79720;
...
uint256 constant ORDER_REWARD = 3 * COLLATERAL_MULTIPLIER;
...
/* ========== scenario 0 ========== */
int256 constant ASSET_PRICE_0 = int256(2_000 * PRICE_MULTIPLIER);
...
/* ========== scenario 1 ========== */
int256 constant ASSET_PRICE_1 = int256(3_000 * PRICE_MULTIPLIER);
int256 constant ASSET_PRICE_1_SHORT = int256(1_000 * PRICE_MULTIPLIER);
int256 constant ASSET_PRICE_1_USD = int256(3_000 * USD_MULTIPLIER);
int256 constant MARK_PRICE_1 = int256(3_000 * PRICE_MULTIPLIER);
...
uint256 constant CLOSE_POSITION_FEE_0 = VOLUME_0 * BASE_USER_FEE / BPS_MULTIPLIER;
bool constant IS_SHORT_0 = false;
uint256 constant ASSET_AMOUNT_0 = 2_500 * ASSET_MULTIPLIER;
int256 constant LIQUIDATION_PRICE_0 =
    ASSET_PRICE_0 - ASSET_PRICE_0 * int256(MARGIN_0 - LIQUIDATOR_REWARD - CLOSE_POSITION_FEE_0_1) / int256(VOLUME_0);

uint256 constant BALANCE_AFTER_CLOSE_0 = MARGIN_0 - CLOSE_POSITION_FEE_0;
...
uint256 constant VOLUME_0_1 =
    (ASSET_AMOUNT_0 * uint256(ASSET_PRICE_1)) * COLLATERAL_MULTIPLIER / PRICE_MULTIPLIER / ASSET_MULTIPLIER;
...
uint256 constant CLOSE_POSITION_FEE_0_1 = VOLUME_0 * BASE_USER_FEE / BPS_MULTIPLIER;

/* ===== position 0 = price 2 (1_800) ===== */
int256 constant ASSET_PRICE_0_2 = int256(1_800 * PRICE_MULTIPLIER);
int256 constant ASSET_PRICE_0_2_USD = int256(1_800 * USD_MULTIPLIER);
uint256 constant VOLUME_0_2 =
    (ASSET_AMOUNT_0 * uint256(ASSET_PRICE_0_2)) * COLLATERAL_MULTIPLIER / PRICE_MULTIPLIER / ASSET_MULTIPLIER;
...
uint256 constant CLOSE_POSITION_FEE_0_2 = VOLUME_0 * BASE_USER_FEE / BPS_MULTIPLIER;
...
int256 constant ASSET_PRICE_0_3 = int256(1_600 * PRICE_MULTIPLIER);
int256 constant ASSET_PRICE_0_3_USD = int256(1_600 * USD_MULTIPLIER);
uint256 constant VOLUME_0_3 =
    (ASSET_AMOUNT_0 * uint256(ASSET_PRICE_0_3)) * COLLATERAL_MULTIPLIER / PRICE_MULTIPLIER / ASSET_MULTIPLIER;
...
int256 constant ASSET_PRICE_1_1 = int256(1_000 * PRICE_MULTIPLIER);
int256 constant ASSET_PRICE_1_1_USD = int256(1_000 * USD_MULTIPLIER);
uint256 constant VOLUME_1_1 =
    (ASSET_AMOUNT_0 * uint256(ASSET_PRICE_1_1)) * COLLATERAL_MULTIPLIER / PRICE_MULTIPLIER / ASSET_MULTIPLIER;
