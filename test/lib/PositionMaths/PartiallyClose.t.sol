...
contract PartiallyClosePositionTest is Test, WithPositionMaths {
    ...
    function testShortAndProfitAndFeeTwice() public {
        ...
        assertEq(
            ...
            int256(MARGIN_0 / 2),
            "total fee amount after two closes"
        );
    ...
    function testPayoutAfterFeeAndProfit() public {
        // ACT
        position.updateFees(BORROW_FEE_INTEGRAL_0, FUNDING_FEE_INTEGRAL_0);
        int256 payout = position.partiallyClose(ASSET_PRICE_1, CLOSE_PROPORTION_1);
